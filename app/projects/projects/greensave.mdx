...
Inspired by some specific reading in the 2022 Inflation Reduction Act, Tyler identified and shared some interesting trends:

In promoting energy-efficient appliances, the bill provided incentives in the form of tax credits to home-owners for replacing their old appliances with new energy-efficient ones.
...
Like the one mentioned above, we found dozens of spreadsheets for thousands of different appliances. Out of all the categories, we felt water heaters were a good place to start for a few reasons:

- The universe of approved heaters was tolerable (about 700)
...
More recently, there's been some innovation, and we now have **tankless water heaters**. Tankless water heaters.. well, they're pretty much exactly as you'd expect. They don't have a tank. Instead, they heat water on-demand by running cold (ground temperature) water through a heating element (gas or electric) and delivering it through the hot water pipes.
...
Determining how well a water heater performs basically boils down to "how much hot water can it produce in a time interval."
...
Max gallons/ minute vs First Hour Rating is kind of like comparing peaches and nectarines. Yeah they're both kinda similar and taste the same, but they're just a little different. Rightly so, the heaters work differently.
...
- Multiple versions of the product are released without any change to the performance of the heater
...
- The user's expected energy peak consumption
...
Our instinct was the first two would be the most used.
...
- a 5 question form
- a results page that shows the user 3 water heater replacements (the most inexpensive today, the most inexpensive over 10 years, the most eco-friendly)
...
First and foremost, massive credit to my partner and co-creator of this project Tyler Fallon who wore many hats including but not limited to
